...
function handleEditClick(e) {
    e.preventDefault();
    editItem.parentElement.childNodes[1].textContent = document.getElementById("item").value;
...
function createNewTask(taskTitle, createdDate, dueDate) {    
    ...
    dateTimeParagraph.appendChild(document.createTextNode('Created:' + createdDate));
